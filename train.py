...
def train(args):
    model = TransferLearningResNet(num_classes=6, dropout_rate_1=0.1, dropout_rate_2=0.1)
    model.to(device)
    ...
    train_dataset = load_data("data/seg_train/seg_train", transform=train_transforms)
    valid_dataset = load_data("data/seg_test/seg_test", transform=valid_transforms)
